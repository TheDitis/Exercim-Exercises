...
mod tests {
    ...
    mod note_tests {
        ...
        // #[test]
        // fn properly_capitalize_white_note() {
        //     assert_eq!(Note::fix_case("e"), "E");
        // }

        #[test]
        fn properly_capitalize_sharp_note() {
            assert_eq!(Note::fix_case("c#"), "C#");
        }

        #[test]
        fn properly_capitalize_flat_note() {
            assert_eq!(Note::fix_case("db"), "Db");
        }
    }
